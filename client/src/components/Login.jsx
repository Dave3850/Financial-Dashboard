  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-md w-full text-center">
        ...
        <h1 className="text-3xl font-bold text-clinch-blue-700 mb-2">Welkom bij Clinch</h1>
        <p className="text-gray-600 mb-8">Vul je agenda automatisch met wachtlijstpatiënten</p>
        <button
          onClick={onLogin}
